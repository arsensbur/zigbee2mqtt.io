...
### Issue with system_mode
There seems to be an issue with system_mode being incorrectly reported. In case you have these issues, try to specify legacy and thermostat_unit in device configuration
```yaml
{
'0xabc457fffe679xyz':
    legacy: true
